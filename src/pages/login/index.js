...
const Login=()=>{
    ...
    return(
        <div className="flex flex-col justify-center items-center h-screen bg-[#191414]">
            ...
            <button className="flex align-center justify-center py-4 px-8 bg-green-500 hover:bg-green-600 focus:ring-2 cursor-pointer focus:ring-green-500 focus:outline-none rounded-full shadow-lg text-white font-bold tracking-wide" onClick={handleLogin}>
